...
public class TestMessage : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        dialogTexts.Add(new DialogData(
            cmdManager.ChangeSize(E_Up_Down_Init.up) +
        ...
        dialogTexts.Add(new DialogData(
            ...
            " color, and /size:up//size:up/size/size:init/ like this.", "Li"));

        dialogTexts.Add(new DialogData("You can easily change text", "Li"));
        dialogTexts.Add(new DialogData("Just put the command in the string!", "Li", () => Show_Example(1)));

        dialogTexts.Add(new DialogData(
            "You can also change the character's sprite /emote:Sad/like this, /click//emote:Happy/Smile.", "Li",
            () => Show_Example(2)));
        ...
        dialogTexts.Add(new DialogData(
            "You don't even need to click on the window like this.../speed:0.1/ tada!/close/", "Li",
            () => Show_Example(5)));

        dialogTexts.Add(new DialogData("/speed:0.1/AND YOU CAN'T SKIP THIS SENTENCE.", "Li", () => Show_Example(6),
            false));
